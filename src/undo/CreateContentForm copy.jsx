...
export const CreateContentForm = ({ photoPost, setPhotoPost, resFormActive, setResFormActive }) => {
  ...
  const handleSubmit = async () => {
    ...
    const coords = await definePosition();
    setPosition(coords);
    console.log("coords submit :>> ", coords);
    localDispatch({ type: "submitPublication" });
